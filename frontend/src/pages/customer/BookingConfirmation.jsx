...
const BookingConfirmation = () => {
    ...
    return (
        <div className="confirmation-page">
            <div className="confirmation-card card">
                ...
                <div className="confirmation-actions">
                    ...
                    <Link to="/" className="btn btn-secondary"><Home size={18} /> Back to Home</Link>
                </div>
        ...
        .confirmation-card { max-width: 500px; text-align: center; padding: var(--space-10); }
        .success-icon { color: var(--success); margin-bottom: var(--space-6); }
        ...
        .detail-item strong { margin-left: auto; color: var(--gray-900); }
